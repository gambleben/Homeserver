...
See the [subguide for Docker Compose](https://github.com/gambleben/Homeserver/tree/master/docker) on how to get up and running. *this is the unique part of this guide, a complete and carefully built working Docker-Compose.yml file with variables.*
...
- Required configuration: Caddy is near-zero configuration but does require you to do your homework first.
  - _To access services via internet securily:_
    - Complete [Step 3. Network Configuration](https://github.com/gambleben/Homeserver/blob/master/network-configuration.md) of the main guide.
...
- Personalize docker-compose by editing your (hidden) `/home/username/docker/.env` file [see example](https://github.com/gambleben/Homeserver/blob/master/docker/.env).
  ...
  3. your registered domain name `yourdomain.tld` (see [Step 3. Network Configuration](https://github.com/gambleben/Homeserver/blob/master/network-configuration.md)) 
...
- Required documentation:
  - Follow the documentation to login to the admin environment (hint: the secret in your `.env` file). 
    ...
    - Fill in your SMTP credentials first and perform the test. See [E-mail notifications](https://github.com/gambleben/Homeserver/blob/master/network-configuration.md#email-notifications) in [Step 3. Network Configuration](https://github.com/gambleben/Homeserver/blob/master/network-configuration.md).   
...
- In `E-mail` disable "instant notifications" to prevent users from being flooded with hundreds of emails when shared files are being downloaded. See [Maintenance & Scheduling](https://github.com/gambleben/Homeserver/tree/master/maintenance-tasks#step-6-schedule-nightly-and-monthly), cron will be used to sent notifications every 5min. 
...
> - Alternatively, [Setup NFS](https://github.com/gambleben/Homeserver/tree/master/network%20share%20(NFSv4.2)) a zero-overhead solution used in datacenters, the fastest way to share files/folders with other devices (laptops/PCs) via your local home network.
